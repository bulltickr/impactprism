...
vulnerability report if that feature is enabled. If private reporting is
unavailable, open a minimal issue asking for a private contact channel; do not
include exploit details, secrets, or customer data in the issue.
...
public disclosure. We will credit reporters who want attribution.
