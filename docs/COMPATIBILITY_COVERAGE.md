...
[v0.4.4 compatibility report](COMPATIBILITY_REPORT.md). The v0.4.1
...
| Field | Value |
|---|---|
| Scanner version at recording | `0.4.4` |
...
| Durable release result | [`v0.4.4 compatibility-result.json`](https://github.com/bulltickr/impactprism/releases/download/v0.4.4/compatibility-result.json) |
...
The v0.4.4 release-artifacts workflow repeated this exact ten-case run from the
...
explicitly identified as pre-release evidence. The v0.4.3 asset remains
available as the prior ten-case release baseline.
