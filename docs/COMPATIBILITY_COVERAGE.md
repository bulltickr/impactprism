...
[v0.4.8 compatibility report](COMPATIBILITY_REPORT.md). The v0.4.1
...
| Field | Value |
|---|---|
| Scanner version in published result | `0.4.8` |
...
| Durable release result | [`v0.4.8 compatibility-result.json`](https://github.com/bulltickr/impactprism/releases/download/v0.4.8/compatibility-result.json) |
...
The v0.4.8 release-artifacts workflow ran this exact ten-case corpus from the
release tag and uploaded the resulting machine-readable JSON with the release
assets. The durable result is linked above. The v0.4.7, v0.4.6, v0.4.4, and v0.4.3
