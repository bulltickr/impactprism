...
1. Show HN: ImpactPrism — checks whether your npm/Go dependencies are actually used, then ships CRA evidence
2. Show HN: Your lockfile is a lie — ImpactPrism checks what your code actually imports
3. Show HN: An offline dependency-integrity scanner for npm and Go with EU CRA evidence output
...
ImpactPrism is early, open source, and intentionally narrow. I would especially like feedback from EU agency developers, indie SaaS founders, security engineers, and npm/Go maintainers: what did the scan find that your current SBOM or dependency check did not?
