...
python -m pip install \
  https://github.com/bulltickr/impactprism/releases/download/v0.4.1/impactprism-0.4.1-py3-none-any.whl
impactprism scan .
```
...
```bash
python -m pip install \
  "git+https://github.com/bulltickr/impactprism.git@v0.4.1"
```
