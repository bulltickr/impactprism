...
PUBLISHED_COMPATIBILITY_VERSION = "0.4.7"
...
def test_compatibility_report_tracks_the_published_release_baseline():
    ...
    # This report is durable evidence from the published v0.4.7 release. Keep
    ...
    assert "releases/download/v0.4.7/compatibility-result.json.sha256" in raw
    assert "Run 32553499413" in raw
